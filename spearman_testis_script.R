...
cor_test <- cor.test(rfx_isoform_1, testis_isoform, method = "spearman")
...
isoform_1_results[i, "spearman"] <- cor_test$estimate
}

# Write the Excel file
write_xlsx(isoform_1_results, "spearman_testis_RFX1.xlsx")
